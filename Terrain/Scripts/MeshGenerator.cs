...
public class MeshGenerator : MonoBehaviour
{
    ...
    public void UpdateShaderProperties()
    {
        ...
        meshMaterial.SetInt("_Lacunarity", lacunarity);
    ...
    public Material BakeTexture(Mesh newMesh)
    {
        CreateDiffuseRT();
    ...
    public void SaveHeightmapPNG()
    {
        ...
        // Fixed save path inside Assets folder
        string path = "Assets/Terrain/Prefabs/" + meshName + "/" + meshName + "HeightMap.png";

        // Write the PNG file
        System.IO.File.WriteAllBytes(path, bytes);

        // Refresh the AssetDatabase so Unity sees it
        AssetDatabase.Refresh();
    }
